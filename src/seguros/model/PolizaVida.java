...
public class PolizaVida extends Poliza {
    ...
    public PolizaVida(int id, int clienteId, String numero, String aseguradora,
            LocalDate fechaInicio, LocalDate fechaVencimiento, double prima, String beneficiario) {
