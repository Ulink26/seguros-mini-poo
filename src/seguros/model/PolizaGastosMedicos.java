...
public class PolizaGastosMedicos extends Poliza {
    ...
    public PolizaGastosMedicos(int id, int clienteId, String numero, String aseguradora,
            LocalDate fechaInicio, LocalDate fechaVencimiento, double prima, String asegurado) {
